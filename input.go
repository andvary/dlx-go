...
// каждой опцией в битовом векторе, а не в ещё одном линкованном списке, что сильно упрощает код (пробовал хранить в
// мапах, но вариант с битовым вектором работает в разы быстрее).
